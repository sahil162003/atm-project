...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel carddetail = new JLabel ("Your 16 digit card numner");
        ...
        c7 =new JCheckBox(" I hereby declare that above entered detail are correct to the best of  knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Railway",Font.BOLD,16));
        c7.setBounds(100,680,7600,30);
        add(c7);
        
        submit = new JButton("Submit");
        submit.setBackground(Color.BLACK);
        submit.setForeground(Color.white);
        submit.setBounds(600,720,80,35);
        ...
        cancel.setBounds(690,720,80,35);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String cardnumber = "" + Math.abs((random.nextLong() % 900000000L) + 50409360000000000L);
